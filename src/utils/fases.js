export const fases = [
  ...
  },
  {
    ...
    "apps":[
      ...
      {"id":4,"name":"Simulador de Escenarios Críticos","summary":"Las IA могут ayudar a preparar al emprendedor para situaciones complejas a través de simulaciones.","template":"Crea una simulación para un negocio de {{sector}} que se enfrenta a {{situacion}} con opciones estratégicas y métricas.","fields":[{"name":"sector","label":"Sector"},{"name":"situacion","label":"Situación crítica"}]},
